...
const CANDIDATE_PATHS = ['/privacy', '/privacy-policy', '/legal/privacy'];
const LINK_PATTERNS = [
  '/privacy',
  '/privacy-policy',
  '/legal/privacy',
...
@Injectable()
export class PrivacyPolicyValidator extends BaseValidator {
  readonly validatorId = 'privacy_policy';
  readonly name = 'Privacy Policy';
